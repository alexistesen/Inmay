...
<!-- USO ESTO PARA INICIALIZAR LA VARIABLE QUE CONTENDRA EL MENSAJE EN CASO DE LOGUEARSE INCORRECTAMENTE -->
<%
	String mensaje=null;
	...
	<!-- Desde la fila 23 a la 128 Pertenece a la Imagen del Muñeco - NO MOVER! -->
<form action="validation" method="POST">
	...
	<!-- Aqui si se puede editar la información de los INPUTS de (USUARIO Y CONTRASEÑA) -->
	<div class="inputGroup inputGroup1">
		<label for="loginEmail" id="loginEmailLabel">Correo</label>
		<input type="email" id="loginEmail" maxlength="254" name="txtEmail" />
		<p class="helper helper1">Ingresa tu Email</p>
	</div>
	<div class="inputGroup inputGroup2">
		<label for="loginPassword" id="loginPasswordLabel">Contraseña</label>
		<input type="password" id="loginPassword" name="txtClave"/>
		<label id="showPasswordToggle" for="showPasswordCheck">Mostrar Contraseña
			<input id="showPasswordCheck" type="checkbox" name="txtClave"/>
			<div class="indicator"></div>
		</label>
	</div>
	<div class="inputGroup inputGroup3">
		<button id="login" name="opcion" value="login">Entrar!</button>
	</div>	
	<div>
		<h1><%=mensaje%></h1>
	</div>
...
<script  src="dist/js/script_del_Login.js"></script>
